...
const categories = [
  {
    id: "wedding-designer",
    label: "Wedding Designer",
    icon: "💍",
    color: "from-rose-500 to-pink-600",
  },
  {
    id: "casual-wear",
    label: "Casual Wear Designer",
    icon: "👕",
...
export default function BecomeProviderPage() {
  ...
  const handleSubmit = () => {
    ...
    alert(
      "Registration submitted! We will review your profile and get back to you soon."
    );
    setStep(1);
    setSelectedCategory("");
    setFormData({
              ...
              <CardContent className="space-y-6">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {(specialtyOptions[selectedCategory] || []).map(
                      (specialty, index) => (
                        <div
                          key={specialty}
                          className="flex items-center gap-3 p-3 rounded-lg bg-white/50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 hover:border-rose-300 dark:hover:border-rose-500 transition-colors"
                        >
                          <Checkbox
                            id={specialty}
          ...
          {step === 4 && (
            <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm shadow-xl animate-slide-up">
              ...
              <CardContent className="space-y-8">
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {formData.specialties.map((specialty) => (
                        <span
                          key={specialty}
                          className="bg-gradient-to-r from-rose-500 to-amber-500 text-white px-4 py-2 rounded-full text-sm font-medium"
                        >
                          {specialty}
                        </span>
                      ))}
                ...
                <div
                  className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-2xl p-6 animate-fade-in-up"
                  style={{ animationDelay: "0.4s" }}
                >
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-green-800 dark:text-green-200 mt-2">
                        Your profile will be reviewed by our team within 24-48
