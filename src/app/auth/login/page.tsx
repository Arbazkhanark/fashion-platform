...
//                     className="w-full pl-10 pr-4 py-3 rounded-lg bg-secondary/50 border border-border focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-smooth"
//                     required
//                     />
//                 </div>
//                 </div>
...
//                     placeholder="••••••••"
//                     className="w-full pl-10 pr-12 py-3 rounded-lg bg-secondary/50 border border-border focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-transparent transition-smooth"
//                     required
//                     />
//                     <button
//                     type="button"
...
//                 </label>
//                 <Link href="#" className="text-primary hover:text-primary/80 transition-smooth font-medium">
//                     Forgot password?
//                 </Link>
//                 </div>
...
//             {/* Divider */}
//             <div className="relative my-6 animate-slide-up" style={{ animationDelay: "500ms" }}>
...
//             {/* Social Login */}
//             <div className="grid grid-cols-2 gap-3 animate-slide-up" style={{ animationDelay: "600ms" }}>
...
//                 <Link href="/auth/register" className="text-primary hover:text-primary/80 font-medium transition-smooth">
//                 Sign up
//                 </Link>
//             </p>
//             </div>
...
import Link from "next/link"
import { Button } from "@/components/ui/button"
import { Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, Star, Users, Palette } from "lucide-react"
import Navigation from "@/components/navigation"
import Footer from "@/components/footer"
        ...
        <div className="w-full max-w-md">
          ...
          <div className={`bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 rounded-3xl p-8 shadow-2xl transition-all duration-1000 ${isVisible ? 'animate-glow-in' : 'opacity-0'}`}>
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg">Sign in to your account to continue your style journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between text-sm animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
                <label className="flex items-center gap-3 cursor-pointer group">
                  <div className="relative">
                    <input type="checkbox" className="w-5 h-5 rounded border-2 border-gray-300 dark:border-gray-600 bg-white/50 dark:bg-gray-700/50 checked:bg-rose-500 checked:border-rose-500 transition-all duration-300" />
                  </div>
                  <span className="text-gray-600 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">Remember me</span>
                </label>
                <Link href="#" className="text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 transition-colors font-medium group">
                  Forgot password?
            ...
            {/* Divider */}
            <div className="relative my-8 animate-fade-in-up" style={{ animationDelay: "0.6s" }}>
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-gray-200 dark:border-gray-700" />
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/80 dark:bg-gray-800/80 text-gray-500 dark:text-gray-400 backdrop-blur-sm">Or continue with</span>
              </div>
            </div>
            ...
            {/* Sign Up Link */}
            <p className="text-center text-gray-600 dark:text-gray-400 mt-8 animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
              Don't have an account?{" "}
              <Link 
                href="/auth/register" 
