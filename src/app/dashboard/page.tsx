...
import { Star, Calendar, Clock, MessageCircle, Edit2, Heart, Sparkles, Users, Award, TrendingUp } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const [bookings, setBookings] = useState<Booking[]>([
    {
      ...
      expertImage: "https://images.pexels.com/photos/712521/pexels-photo-712521.jpeg",
      date: "2024-11-25",
      time: "2:00 PM",
      status: "confirmed",
      totalPrice: 50000,
    ...
    },
    {
      ...
      expertImage: "https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg",
      date: "2024-11-20",
      time: "10:00 AM",
      status: "completed",
      totalPrice: 8000,
  ...
  const [newReview, setNewReview] = useState({ expertId: "", rating: 5, comment: "" })
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? 'animate-glow-in' : 'opacity-0'}`}>
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white mb-4">
            My <span className="bg-gradient-to-r from-rose-600 to-amber-600 bg-clip-text text-transparent">Dashboard</span>
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {[
            { icon: Calendar, value: upcomingBookings.length, label: "Upcoming", color: "from-blue-500 to-cyan-500" },
            { icon: Heart, value: favorites.length, label: "Favorites", color: "from-rose-500 to-pink-500" },
            { icon: Star, value: reviews.length, label: "Reviews", color: "from-amber-500 to-orange-500" },
            { icon: Award, value: "VIP", label: "Member", color: "from-purple-500 to-violet-500" },
          ].map((stat, index) => (
            <div 
              key={index}
            ...
            >
              <div className={`w-12 h-12 rounded-2xl bg-gradient-to-r ${stat.color} flex items-center justify-center mx-auto mb-4 shadow-lg`}>
        ...
        <Tabs defaultValue="bookings" className="space-y-8">
          ...
          <TabsContent value="bookings" className="space-y-8">
            ...
            <div className="animate-slide-up">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Upcoming Appointments</h2>
              {upcomingBookings.length > 0 ? (
                  ...
                  {upcomingBookings.map((booking, index) => (
                    ...
                    >
                      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-600 dark:to-gray-700">
                        ...
                        />
                        <div
                          className={`absolute top-4 right-4 px-4 py-2 rounded-full text-sm font-semibold backdrop-blur-sm ${getStatusColor(booking.status)}`}
                        >
                      ...
                      <CardContent className="pt-6 space-y-4">
                        <div>
                          <h3 className="font-bold text-xl text-gray-900 dark:text-white mb-1">{booking.expertName}</h3>
                          <p className="text-rose-600 dark:text-rose-400 font-medium">{booking.location}</p>
                        </div>
                ...
                <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                  <CardContent className="pt-6 text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-4 text-lg">No upcoming appointments</p>
                    <Link href="/designers">
            ...
            <div className="animate-slide-up" style={{ animationDelay: "0.2s" }}>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Past Appointments</h2>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            />
                            <div>
                              <h3 className="font-bold text-gray-900 dark:text-white">{booking.expertName}</h3>
                          ...
                          <div className="text-right">
                            <p
                              className={`text-sm font-semibold px-4 py-2 rounded-full backdrop-blur-sm ${getStatusColor(booking.status)}`}
                            >
                              {booking.status.charAt(0).toUpperCase() + booking.status.slice(1)}
                            </p>
                            {booking.status === "completed" && (
                              <Link href={`/dashboard/review/${booking.expertId}`}>
                                <Button size="sm" className="mt-2 bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white">
                                  Leave Review
                                </Button>
                              </Link>
                            )}
          ...
          {/* Favorites Tab */}
          <TabsContent value="favorites" className="space-y-8 animate-slide-up">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Saved Favorites</h2>
            {favorites.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {favorites.map((favorite, index) => (
                  ...
                  >
                    ...
                    <CardContent className="pt-6 space-y-4">
                      <div>
                        <h3 className="font-bold text-xl text-gray-900 dark:text-white mb-1">{favorite.name}</h3>
                        <p className="text-rose-600 dark:text-rose-400 font-medium">{favorite.title}</p>
                      </div>
                        ...
                        <div className="flex">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`w-4 h-4 ${
                                i < Math.floor(favorite.rating) ? "fill-amber-400 text-amber-400" : "text-gray-300 dark:text-gray-600"
                              }`}
                            />
                          ))}
                        </div>
                        <span className="text-sm font-semibold text-gray-900 dark:text-white">{favorite.rating}</span>
                        <span className="text-sm text-gray-600 dark:text-gray-400">({favorite.reviews})</span>
                      </div>
              ...
              <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                <CardContent className="pt-6 text-center py-12">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-4 text-lg">No favorites yet</p>
                  <Link href="/designers">
                    <Button className="bg-gradient-to-r from-rose-500 to-amber-500 hover:from-rose-600 hover:to-amber-600 text-white">
                      Browse Experts
                    </Button>
          ...
          <TabsContent value="reviews" className="space-y-8 animate-slide-up">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Write a Review</h2>
              <Card className="border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
                <CardContent className="pt-6 space-y-6">
                  <div className="animate-fade-in-up">
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Select Expert</label>
                    <select
                      value={newReview.expertId}
                      onChange={(e) => setNewReview((prev) => ({ ...prev, expertId: e.target.value }))}
                  ...
                  <div className="animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Rating</label>
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        ...
                        >
                          <Star
                            className={`w-6 h-6 ${
                              star <= newReview.rating ? "fill-amber-400 text-amber-400" : "text-gray-300 dark:text-gray-600"
                            }`}
                          />
                        </button>
                      ))}
                  ...
                  <div className="animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Your Review</label>
                    <Textarea
            ...
            {/* My Reviews */}
            <div className="animate-slide-up" style={{ animationDelay: "0.2s" }}>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">My Reviews</h2>
              {reviews.length > 0 ? (
                    ...
                    >
                      <CardContent className="pt-6">
                        <div className="flex justify-between items-start mb-4">
                          <div>
                            <h3 className="font-bold text-xl text-gray-900 dark:text-white">{review.expertName}</h3>
                              ...
                              <div className="flex">
                                {[...Array(5)].map((_, i) => (
                                  <Star
                                    key={i}
                                    className={`w-4 h-4 ${
                                      i < review.rating ? "fill-amber-400 text-amber-400" : "text-gray-300 dark:text-gray-600"
                                    }`}
                                  />
                                ))}
                              </div>
              ...
              <CardContent className="pt-6 space-y-6">
                {!editingProfile ? (
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in-up">
                      ...
                      <div className="p-4 rounded-xl bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50">
                        ...
                        <p className="font-bold text-lg text-gray-900 dark:text-white">{profileData.email}</p>
                      </div>
                      <div className="p-4 rounded-xl bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Phone</p>
                        <p className="font-bold text-lg text-gray-900 dark:text-white">{profileData.phone}</p>
                      </div>
                      <div className="p-4 rounded-xl bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50">
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Location</p>
                        <p className="font-bold text-lg text-gray-900 dark:text-white">{profileData.location}</p>
                      </div>
                    </div>
                    <div className="p-4 rounded-xl bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Bio</p>
                      <p className="font-bold text-gray-900 dark:text-white">{profileData.bio}</p>
                    </div>
                    <Button 
                  ...
                  <>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in-up">
                      <div>
                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Full Name</label>
                        <Input
                      ...
                      <div>
                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Email</label>
                        <Input
                          type="email"
                      ...
                      <div>
                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Phone</label>
                        <Input
                      ...
                      <div>
                        <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Location</label>
                        <Input
                    ...
                    <div className="animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
                      <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3 block">Bio</label>
                      <Textarea
