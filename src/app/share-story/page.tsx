      ...
      <>
        ...
        <main className="min-h-screen bg-gradient-to-b from-white to-rose-50/30 dark:from-gray-900 dark:to-rose-900/20 flex items-center justify-center">
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div
              className={`bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-12 border border-gray-200/50 dark:border-gray-700/50 transition-all duration-1000 ${
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
                Thank you for sharing your style transformation journey. Our
                team will review your story and it will be live on our platform
                within 24 hours.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/real-stories">
                  <Button
                    variant="outline"
                    className="bg-transparent border-rose-200 dark:border-rose-800 text-rose-700 dark:text-rose-300"
                  >
                    View All Stories
                  </Button>
                </Link>
        ...
        <section className="py-16 bg-gradient-to-r from-rose-50/50 to-amber-50/30 dark:from-rose-900/10 dark:to-amber-900/5 border-b border-rose-100 dark:border-rose-800/30">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link
                href="/real-stories"
                className="inline-flex items-center gap-2 text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 mb-6 transition-colors group"
              >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            value={form.userAge}
                            onChange={(e) =>
                              handleInputChange("userAge", e.target.value)
                            }
                      ...
                      <div className="flex items-start gap-3 p-4 bg-rose-50 dark:bg-rose-900/20 rounded-lg">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            I give permission to StyleConnect to share my story
                            and photos on their platform and social media
                            channels.
                          </p>
                        </div>
                      </div>
