...
//               <Checkbox checked={filters.category === cat.id} onCheckedChange={() => handleCategoryChange(cat.id)} />
...
//                 filters.minRating === rating ? "bg-accent text-accent-foreground" : "hover:bg-secondary text-foreground"
//               }`}
//             >
